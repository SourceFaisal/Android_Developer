...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Recyler View_066_Faisal");
        ...
        RecipeListAdapter recipeListAdapter = new RecipeListAdapter(this, mRecipeNames, mRecipeDesc);
