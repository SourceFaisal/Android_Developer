...
public class RecipeListAdapter extends AppCompatActivity implements RecipeListAdapterr {

    private final LinkedList<String> mRecipeName;
    private final LinkedList<String> mRecipeDesc;
    private final LayoutInflater mLayoutInflater;
    public final static String EXTRA_NAME = "id.ac.poliban.e020320066.homework4_5.EXTRA.NAME";
    ...
    public RecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mItemView = mLayoutInflater.inflate(R.layout.activity_recipe_list_adapter, parent, false);
