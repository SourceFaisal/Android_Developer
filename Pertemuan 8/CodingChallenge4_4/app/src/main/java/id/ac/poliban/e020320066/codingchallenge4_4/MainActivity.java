package id.ac.poliban.e020320066.codingchallenge4_4;
...
import id.ac.poliban.e020320066.codingchallenge4_4.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Nav Drawer Experiment Faisal");
