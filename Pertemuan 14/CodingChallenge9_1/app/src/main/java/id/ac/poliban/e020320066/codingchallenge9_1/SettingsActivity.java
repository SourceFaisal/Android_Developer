...
public class SettingsActivity extends AppCompatActivity implements SettingActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.e020320066.codingchallenge9_1";
