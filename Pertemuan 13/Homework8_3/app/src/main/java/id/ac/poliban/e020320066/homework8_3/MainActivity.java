package id.ac.poliban.e020320066.homework8_3;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar()
                .setTitle("Job Scheduler Download Faisal");
    ...
    public void scheduleDownload(View view) {
        sendNotification();
        JobScheduler mScheduler = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mScheduler = (JobScheduler) getSystemService(JOB_SCHEDULER_SERVICE);
        }
        ComponentName componentName = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            componentName = new ComponentName(getApplicationContext(), DownloadService.class.getName());
        }
